...
data class SubscriptionWithMembers(
    ...
    val platformPrices: List<com.apleq.app.data.model.PlatformPriceItem>
        get() = com.apleq.app.data.model.PlatformPricingHelper.parse(subscription.platformPricing)
